...
export const farmsV3 = defineFarmV3Configs([
  ...
  {
    pid: 1,
    lpAddress: '0x6167572E08ff57578a065FDb277928829b3aa7a3',
    token0: bscTokens.wbnb,
    token1: bscTokens.busd,
    feeAmount: FeeAmount.LOW,
  },
...
const farms: SerializedFarmConfig[] = [
...

  {
    pid: 3,
    lpSymbol: 'KNIGHT',
    lpAddress: '0xA12e1e2E2dea79694448aB9ef63bd4D82a26d90c',
    token: bscTokens.knight,
    isToken: true,
    quoteToken: bscTokens.busd,
  },
  {
  ...
  },
  {
    ...
    token: bscTokens.wizard,
    quoteToken: bscTokens.wbnb,
  },
  {
    pid: 5,
    lpSymbol: 'Guard-BUSD LP',
    lpAddress: '0xfC84B031a5221CED00b6470744aF5e5dA5710dDC',
    token: bscTokens.guard,
    quoteToken: bscTokens.busd,
  },
  {
    pid: 6,
    lpSymbol: 'ETH-BNB LP',
    lpAddress: '0x0ddF35e107b6014B5577e87e3BBCECa74df3e09A',
    token: bscTokens.eth,
    quoteToken: bscTokens.wbnb,
  },
  {
    ...
    lpAddress: '0xC71201ccE9d64B7C33E40FbeC058fA14597862fE',
  ...
  },
  {
    ...
    lpAddress: '0xaeFa492bbce96e8Cc1427511E21e7Ca1b172cb58',
    token: bscTokens.dai,
    quoteToken: bscTokens.usdt,
  },
  {
    ...
    lpAddress: '0x423496120476272E8ddFfb72dfF7586502BEb43e',
  ...
  },
  {
    ...
    token: bscTokens.crush,
    quoteToken: bscTokens.wbnb,
  },
  {
    pid: 11,
    lpSymbol: 'WOLFIE-BUSD LP',
    lpAddress: '0xA59F9f3Cf28F5Ea5b4dB135E282fCC8157781846',
    token: bscTokens.wolfies,
    quoteToken: bscTokens.busd,
  },
  {
    pid: 12,
  ...
  },
  {
    ...
    token: bscTokens.kronos,
    quoteToken: bscTokens.wbnb,
  },
  {
    pid: 30,
    lpSymbol: 'FTM-BNB LP',
    lpAddress: '0x495eA7F561450D367F55A273b5F31BA5Daf8C3B2',
    token: bscTokens.ftm,
    quoteToken: bscTokens.wbnb,
  },
  {
    ...
    token: bscTokens.marvin,
    quoteToken: bscTokens.wbnb,
  },
  {
    pid: 32,
    lpSymbol: 'BUSD-USDC LP',
    lpAddress: '0xd215F5A4789fb2778d7f0EfCf58cA8f5322c8f8e',
...

  {
    pid: 35,
    lpSymbol: 'SWC-BNB LP',
    lpAddress: '0x5190bdE9F111ed6eE1886640695e424103F916B5',
    token: bscTokens.swc,
    quoteToken: bscTokens.wbnb,
  },
  {
    pid: 36,
    lpSymbol: 'ALYX-BNB LP',
    lpAddress: '0x973870304eF53b0A1801c95B80F17B17ce1CCCcB',
    token: bscTokens.alyx,
    quoteToken: bscTokens.wbnb,
  },
  {
    pid: 37,
    lpSymbol: 'BNB-USDT LP',
    lpAddress: '0xb28Ec66a3400B0B8fFF028B121Ed664B9d363CC4',
    token: bscTokens.wbnb,
    quoteToken: bscTokens.usdt,
  },
  {
    pid: 38,
    lpSymbol: 'KNIGHT-USDT LP',
    lpAddress: '0xA90659E0FCAEFa5D1aA5dB4Adc17621D5baD142f',
    token: bscTokens.knight,
    quoteToken: bscTokens.usdt,
  },
  {
    pid: 39,
    lpSymbol: 'BNB-BKB LP',
    lpAddress: '0x851a3Fe77D128e1b4A450781c6660693E299dC59',
    token: bscTokens.bkb,
    quoteToken: bscTokens.wbnb,
  },
  {
    pid: 42,
    lpSymbol: 'BNB-ADA LP',
    lpAddress: '0x14dDfa1F9595EBbEe6Ff22f7f7803dF3F0149013',
    token: bscTokens.ada,
    quoteToken: bscTokens.wbnb,
  },
  {
    pid: 43,
    lpSymbol: 'USDT-GUARD LP',
    lpAddress: '0xd55cbda67576e2620Cf4c869C031dC845502067D',
    token: bscTokens.guard,
    quoteToken: bscTokens.usdt,
  },
